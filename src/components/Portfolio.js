    ...
    return (
        <div className="Adj-text">
            ...
            <p>The projects, as well as this website, are run on cloud infrastructure (GCP) powered by Kubernetes. The
                front-end is a React app, while the back-end is an Actix web server running a REST and GraphQL API, with
                computations handled by containerized Rust and Python. This is of course over-engineered but serves as
                a better demonstration of different techniques.</p>
        </div>
    );
}
