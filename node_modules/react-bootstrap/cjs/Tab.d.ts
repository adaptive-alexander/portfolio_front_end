...
declare const _default: React.FC<TabProps> & {
    Container: {
        ({ transition, ...props }: import("react-bootstrap/cjs/TabContainer").TabContainerProps): JSX.Element;
        propTypes: {
    ...
    Content: import("react-bootstrap/cjs/helpers").BsPrefixRefForwardingComponent<"div", unknown>;
